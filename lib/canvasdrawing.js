 ...
 * @param {MouseEvent} e
 */
CanvasDrawing.prototype.drawStart = function(e, left, top) {
	...
	// if specific x / y values have been passed use them, otherwise figure it out
	x = (x) ? x : cd.offset(cd.canvas, e).x;
	y = (y) ? y : cd.offset(cd.canvas, e).y;
 ...
 * @param {MouseEvent} e
 */
CanvasDrawing.prototype.draw = function(e, left, top) {
