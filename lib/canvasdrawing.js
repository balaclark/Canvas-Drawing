...
function CanvasDrawing(canvasId, options) {
	...
	if (this.options.freeDrawing) {
		if (this.canvas.addEventListener) {
			...
			// touch events
			this.canvas.addEventListener("touchstart", controls, false);
			this.canvas.addEventListener("touchmove", controls, false);
			document.addEventListener("touchend", controls, false);
		} else {
			// IE
			this.canvas.attachEvent("onmousedown", controls);
			this.canvas.attachEvent("onmousemove", controls);
